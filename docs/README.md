...
- [离线候选选择与四态核验](../agent_core/README.md)：冻结合成样本、回放分类和独立判分；真实 Jev API 访问已由任务 21 验证，手机内影子建议已由任务 22 验证，实际选择、核验及规划策略尚待任务 23–25。
