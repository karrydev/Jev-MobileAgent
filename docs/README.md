...
- [离线候选选择与四态核验](../agent_core/README.md)：冻结合成样本、回放分类和独立判分；真实 Jev API 访问已由任务 21 验证，手机内影子建议已由任务 22 验证，受控选择已由任务23真实配对验证，树核验及规划策略尚待任务24–25。
...
- [手机内 Jev 影子验证](../.scratch/mobile-agent-v1/evidence/jev-shadow-validation.md)：真实协议、冻结留出、中文/视觉任务与候选缺失反例；不证明 Jev 实际执行成功率。
