...
更新日期：2026-09-22。本文记录已经确定的方向，作为后续开发的入口。文档只保留当前方案。本轮只更新文档，尚未 Fork、裁剪上游代码、实现 App 或运行模型及真机评测。
...
“公开”是已确认的仓库方向；当前文档工作并不代表已创建远程仓库或发布代码。

## 2. v3.5 具体复用什么

已审阅上游提交为 `11cea575561fb7800b5fb6b6cafa56f7a91de11f`。正式开发时记录实际选择的提交，不能把调研时的 `main` 当作永久不变的版本。
